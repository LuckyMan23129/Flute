...
//long sleepTimer = 600;                  // Sleep Timer holds the time to sleep 600*1(s) = 10m
uint16_t sleepTimer = 178;                // Sleep Timer holds the time to sleep 180*1(s) = 3m
//uint16_t sleepTimer = 360;              // Sleep Timer holds the time to sleep 360*10(s) = 1h
